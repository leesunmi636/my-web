  ...
  <article class="product-card">
    <div class="product-art ${product.tone}">
      ...
      <div class="invite-card">
        <span class="mini-mark">S E O J E R O</span>
...
document.querySelector('#app').innerHTML = `
  ...
  <header class="header">
    <a class="logo" href="#top" aria-label="서제로 홈">SEOJERO<span>°</span></a>
  ...
  <main id="top">
    ...
    <section class="statement" id="story"><p class="eyebrow">SEOJERO'S PHILOSOPHY</p><h2>한 장의 종이 위에,<br>두 사람만의 <em>온도</em>를 담습니다.</h2><p>유행보다 오래 남는 디자인, 손끝에서 느껴지는 좋은 질감.<br>서제로는 당신의 이야기가 가장 자연스럽게 피어날 방법을 고민합니다.</p></section>
    ...
    <section class="custom" id="guide">
      <div class="custom-visual"><div class="custom-card"><span>SEOJERO</span><strong>J &amp; S</strong><small>WITH ALL OUR LOVE</small></div><span class="wax-seal">S</span></div>
    ...
    <section class="journal"><p class="eyebrow">FROM SEOJERO JOURNAL</p><h2>결혼 준비의 순간들</h2><div class="journal-grid"><a href="#"><span>01</span><strong>청첩장, 언제부터 준비해야 할까요?</strong><b>→</b></a><a href="#"><span>02</span><strong>우리에게 어울리는 종이 고르기</strong><b>→</b></a><a href="#"><span>03</span><strong>마음을 전하는 청첩장 문구들</strong><b>→</b></a></div></section>
  </main>
  <footer><div class="footer-top"><a class="logo" href="#top">SEOJERO<span>°</span></a><p>인생의 가장 빛나는 시작을<br>아름다운 종이 위에 기록합니다.</p><a class="instagram" href="#instagram">INSTAGRAM ↗</a></div><div class="footer-bottom"><span>© 2026 SEOJERO. ALL RIGHTS RESERVED.</span><span>SEOUL, KOREA · HELLO@SEOJERO.COM</span><span>TERMS &nbsp; PRIVACY</span></div></footer>
`
